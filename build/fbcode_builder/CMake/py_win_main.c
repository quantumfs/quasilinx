...
int locate_py_main(int argc, wchar_t** argv) {
  ...
  add_search_path(L"C:\\tools\\python\\python36\\");
  add_search_path(L"C:\\Python37\\");
  add_search_path(L"C:\\tools\\python\\python37\\");
  add_search_path(L"C:\\Python38\\");
  add_search_path(L"C:\\tools\\python\\python38\\");
  // TODO(T123615656): Re-enable Python 3.9 after the fix
  // add_search_path(L"C:\\tools\\python\\python39\\");
